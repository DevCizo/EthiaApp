...
//  IDTrack
//
//  Created by Intelivita on 11/8/17.
...
class CustomTextField: UITextField, UITextFieldDelegate {
    ...
    override func textRect(forBounds bounds: CGRect) -> CGRect{
        let padding = UIEdgeInsets(top: 0, left: TextBound, bottom: 0, right: 10)
        return UIEdgeInsetsInsetRect(bounds, padding)// bounds.insetBy(dx: TextBound,dy: EditBound)
    }
    
    override func editingRect(forBounds bounds: CGRect) -> CGRect{
        let padding = UIEdgeInsets(top: 0, left: EditBound, bottom: 0, right: 10)
